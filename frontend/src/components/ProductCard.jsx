const ProductCard = ({ product }) => {
  ...
  return (
    <div className="relative bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">

      {/* Discount Badge */}
      <div className="absolute top-0 left-0 bg-red-600 text-white px-4 py-2 rounded-br-xl font-bold z-10">
        {discountPercent}% OFF
      </div>

      {/* Image */}
      <div className="h-56 bg-[#F7F8F8] flex justify-center items-center border-b p-4">
      ...
      <div className="p-5">
        ...
        <h2 className="text-xl font-bold text-[#0F1111] h-14">
          {product.name}
        </h2>
        ...
        <div className="mt-5">
          ...
          <span className="text-4xl font-bold text-[#0F1111]">
        ...
        {/* Savings */}
        <div className="text-green-700 text-sm mt-2 font-semibold">
        ...
        <div className="flex gap-3 mt-6">
          ...
          <button className="flex-1 bg-[#FFD814] hover:bg-[#F7CA00] py-3 rounded-full font-semibold shadow-sm transition">
            Add to Cart
          </button>

          <button className="flex-1 bg-[#FFA41C] hover:bg-[#FA8900] py-3 rounded-full font-semibold shadow-sm transition">
            Buy Now
          </button>
