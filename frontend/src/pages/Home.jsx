    ...
    <div className="min-h-screen bg-[#F2F3F3]">
      ...
      <div className="bg-[#131921] px-8 py-5">
        ...
        <div className="flex justify-between items-center">
          ...
          <div>
            <h1 className="text-[#FF9900] text-3xl font-bold">
              Amazon
            </h1>
      ...
      <div className="px-8 mt-8">
        ...
        <div className="bg-gradient-to-r from-[#131921] to-[#1F3A56] rounded-2xl p-10 text-white shadow-lg">
          ...
          <p className="text-xl text-slate-200 mb-8 max-w-2xl">
            Manage returns and contribute to a sustainable future
            through Amazon Second Life Commerce.
          </p>

          <button
            onClick={() => navigate("/orders")}
            className="bg-[#FF9900] text-black font-semibold px-6 py-3 rounded-lg hover:bg-[#e88a00] transition"
          >
            View All Orders
          </button>
